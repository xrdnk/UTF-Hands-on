...
namespace UnityUITest
{
    public class UITest
    {
        ...
        IEnumerator LoadSceneInternal(string name)
        {
            ...
            {
                EditorSceneManager.LoadSceneAsyncInPlayMode(name, new LoadSceneParameters(LoadSceneMode.Single));
        ...
        protected abstract class Condition
        {
            ...
            protected Condition(string param)
            {
                this.param = param;
            }

            protected Condition(string objectName, string param)
            {
                this.param = param;
